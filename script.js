const translations = {
  en: {
    ...
    "hero.lead":
      "I work across AI, intelligent agents, memory mechanisms, long-sequence modeling, and health AI, with an emphasis on clear modeling ideas, reproducible experiments, and useful software.",
    ...
    "about.p1":
      "I am a Ph.D. student at <strong>George Mason University</strong>, advised by <strong>Prof. Xuan Wang</strong>. My current interests include intelligent agents, memory mechanisms, long-context reasoning, state-space and sequence modeling, and AI for health data.",
    "about.p2":
      "I like projects where a clean modeling idea has to survive real experiments: long-context benchmarks, controlled ablations, GPU training workflows, and software that turns research ideas into usable systems.",
  ...
  zh: {
    ...
    "hero.lead":
      "我的研究方向包括 AI、智能体、记忆机制、长序列建模和健康 AI，关注清晰的建模思想、可复现实验和可用的软件系统。",
    ...
    "about.p1":
      "我是 <strong>George Mason University</strong> 电子与计算机工程博士研究生，导师是 <strong>Prof. Xuan Wang</strong>。我目前关注智能体、记忆机制、长上下文推理、状态空间与序列建模，以及面向健康数据的 AI。",
    "about.p2":
      "我更偏好能经受真实实验检验的研究：长上下文基准、受控消融、GPU 训练流程，以及把研究想法转化为可用系统的软件实现。",
    "areas.kicker": "研究方向",
