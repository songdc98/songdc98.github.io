const translations = {
  en: {
    ...
    "skills.engineering.4": "GPU profiling and performance tuning",
    ...
    "education.gmu.body":
      "Linear systems, random processes, Kalman filtering, distributed control and optimization, system identification, Advanced Learning from Data.",
    "education.southampton.degree": "M.Sc. in Computer Science",
  ...
  zh: {
    ...
    "skills.engineering.4": "GPU 性能分析与优化",
    ...
    "education.gmu.body": "线性系统、随机过程、卡尔曼滤波、分布式控制与优化、系统辨识、Advanced Learning from Data。",
