const translations = {
  en: {
    ...
    "meta.description":
      "Dachuan Song is a Ph.D. student in Electrical and Computer Engineering at George Mason University working on agent memory, long-context reasoning, sequence modeling, and AI evaluation.",
    "language.button": "中文",
    ...
    "nav.cv": "CV",
    "nav.contact": "Contact",
    "hero.eyebrow": "Agent Memory · Long-Context Reasoning · Sequence Modeling · AI Evaluation",
    "hero.lead":
      "I work on AI agents and memory: how models store, retrieve, validate, and act on information over long contexts. My research connects long-sequence modeling, controlled evaluation, and reproducible experiments for reliable AI systems.",
    ...
    "about.title": "Agent Memory, Long Contexts, and Evaluation.",
    "about.p1":
      "I am a Ph.D. student at <strong>George Mason University</strong>, advised by <strong>Prof. Xuan Wang</strong>. My current interests center on agent memory, long-context reasoning, sequence modeling, and evaluation methods that separate real capability from measurement artifacts.",
    "about.p2":
      "My current work is centered on AI-system questions: when an agent should trust memory, how long-context models preserve useful state, and how controlled experiments make these claims testable.",
    "areas.kicker": "Research Areas",
    "areas.agent.title": "Agent Memory & Reliability",
    "areas.agent.body":
      "Memory interfaces for agents that must retrieve facts, validate their current use, track provenance, and avoid stale or unsafe actions.",
    ...
    "areas.health.title": "Evaluation & Research Engineering",
    "areas.health.body":
      "Controlled ablations, benchmark audits, multi-seed analysis, and reproducible GPU workflows for distinguishing real model behavior from artifacts.",
    ...
    "skills.dl.title": "Deep Learning Foundations",
    ...
    "skills.agent.title": "Agent & Memory Systems",
    "skills.agent.1": "Memory validity and provenance",
    ...
    "contact.title": "Open to collaborations on agent memory, long-context reasoning, and AI evaluation.",
  },
  zh: {
    "meta.title": "Dachuan Song | AI 研究与工程",
    "meta.description":
      "Dachuan Song 是 George Mason University 电子与计算机工程博士研究生，研究方向包括智能体记忆、长上下文推理、序列建模和 AI 评估。",
    "language.button": "EN",
    ...
    "nav.cv": "简历",
    "nav.contact": "联系",
    "hero.eyebrow": "智能体记忆 · 长上下文推理 · 序列建模 · AI 评估",
    "hero.lead":
      "我的研究聚焦 AI 智能体与记忆：模型如何在长上下文中存储、检索、验证并使用信息。我关注长序列建模、受控评估和可复现实验如何支撑可靠 AI 系统。",
    ...
    "profile.location": "Fairfax, Virginia, USA",
    "about.kicker": "方向",
    "about.title": "智能体记忆、长上下文与评估。",
    "about.p1":
      "我是 <strong>George Mason University</strong> 电子与计算机工程博士研究生，导师是 <strong>Prof. Xuan Wang</strong>。我目前关注智能体记忆、长上下文推理、序列建模，以及区分真实能力和测量伪影的评估方法。",
    "about.p2":
      "我当前的研究聚焦 AI 系统问题：智能体何时应该信任记忆，长上下文模型如何保留有用状态，以及如何用受控实验让这些判断可检验。",
    "areas.kicker": "研究方向",
    "areas.agent.title": "智能体记忆与可靠性",
    "areas.agent.body":
      "研究智能体在检索事实、验证当前使用、追踪来源和避免过期或不安全行动时所需要的记忆接口。",
    "areas.sequence.title": "长上下文与序列建模",
    "areas.sequence.body":
      "研究模型如何在长输入中保留、聚合和使用信息，包括序列算子、状态空间思想和长度泛化问题。",
    "areas.health.title": "评估与研究工程",
    "areas.health.body":
      "通过受控消融、基准审计、多随机种子分析和可复现 GPU 流程，区分真实模型行为和实验伪影。",
    "skills.kicker": "技能",
    "skills.title": "技术能力。",
    ...
    "skills.agent.title": "智能体与记忆系统",
    "skills.agent.1": "记忆有效性与来源追踪",
    ...
    "contact.kicker": "联系",
    "contact.title": "欢迎交流智能体记忆、长上下文推理和 AI 评估方向的合作。",
  },
};
