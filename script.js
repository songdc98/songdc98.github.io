const translations = {
  en: {
    ...
    "nav.cv": "CV",
    "nav.contact": "Contact",
    "hero.eyebrow": "Deep Learning · Long Contexts · LLM Agents · Model Evaluation",
    "hero.lead":
    ...
    "about.p1":
      "I am a Ph.D. student at <strong>George Mason University</strong>, advised by <strong>Prof. Xuan Wang</strong>. My current interests include deep learning, long-context and sequence modeling, LLM-based agents, and methods for understanding and improving model capabilities.",
    "about.p2":
      "I focus on model generalization, long-context modeling, reliable information aggregation, and agent workflows where evaluation and diagnosis help improve model behavior.",
    ...
    "areas.health.title": "Model Evaluation & Improvement",
    "areas.health.body":
      "Evaluation and diagnostic methods for understanding model capabilities, exposing biases or artifacts, and guiding better model design.",
    ...
    "work.title": "Research papers and project lines.",
    "work.link.paper": "Paper",
    "work.link.code": "Code",
    "work.links.es": "Elastic Spectral State Space Models links",
    "work.links.fmri": "fMRI journal article links",
    "work.links.bcb": "ACM BCB conference paper links",
    ...
    "work.fmri.time": "2025 · Journal Article",
    "work.fmri.title": "Reconstructing brain causal dynamics for subject and task fingerprints using fMRI time-series data",
    "work.fmri.body":
    ...
    "work.bcb.time": "2024 · Conference Paper · Oral Presentation",
    "work.bcb.title": "Causality-based Subject and Task Fingerprints using fMRI Time-series Data",
    "work.bcb.body":
    ...
    "work.bcb.stack": "ACM BCB · Causal modeling · fMRI · Health AI",
  ...
  zh: {
    ...
    "nav.cv": "简历",
    "nav.contact": "联系",
    "hero.eyebrow": "深度学习 · 长上下文 · LLM 智能体 · 模型评估",
    "hero.lead":
    ...
    "about.p1":
      "我是 <strong>George Mason University</strong> 电子与计算机工程博士研究生，导师是 <strong>Prof. Xuan Wang</strong>。我目前关注深度学习、长上下文与序列建模、基于大语言模型的智能体，以及理解和提升模型能力的方法。",
    "about.p2":
      "我关注模型泛化、长上下文建模、可靠信息聚合，以及评估和诊断如何帮助改进智能体工作流中的模型行为。",
    "areas.kicker": "研究方向",
    ...
    "areas.health.title": "模型评估与改进",
    "areas.health.body":
      "通过评估和诊断方法理解模型能力、暴露偏差或实验伪影，并为更好的模型设计提供依据。",
    "skills.kicker": "技能",
    "skills.title": "技术能力。",
    ...
    "work.link.paper": "论文",
    "work.link.code": "代码",
    "work.links.es": "弹性谱状态空间模型相关链接",
    "work.links.fmri": "fMRI 期刊论文相关链接",
    "work.links.bcb": "ACM BCB 会议论文相关链接",
    ...
    "work.fmri.time": "2025 · 期刊论文",
    "work.fmri.title": "使用 fMRI 时间序列数据重建用于主体和任务指纹识别的大脑因果动态",
    "work.fmri.body":
      "重建用于主体和任务指纹识别的大脑因果动态，将因果时序建模与可解释神经信号连接起来。",
    "work.fmri.stack": "fMRI · 因果动态 · 时序建模 · 健康 AI",
    "work.bcb.time": "2024 · 会议论文 · 口头报告",
    "work.bcb.title": "基于因果性的 fMRI 时间序列主体与任务指纹识别",
    "work.bcb.body":
      "通过因果建模研究 fMRI 时间序列中的主体与任务指纹识别，并在 ACM BCB 2024 作口头报告。",
    "work.bcb.stack": "ACM BCB · 因果建模 · fMRI · 健康 AI",
